...
public class CourseInheritance{
    public static void main(String[] args){
        OnlineCourse oc=new OnlineCourse("Java Programming",8,4000,"Coursera");
        OfflineCourse ofc=new OfflineCourse("Data Science",12,15000,"Pune Center");
        HybridCourse hc=new HybridCourse("AI Bootcamp",10,12000,"Weekend Only");
