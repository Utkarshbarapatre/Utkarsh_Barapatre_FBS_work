class Defence{
    ...
    Defence(String nameOfHead,int noOfTroops,double budget,int noOfDept,int noOfVehicles,String locationOfHeadquarters,
             String countryName,int manpowerCount,int noOfBases,int noOfMissionsPerformed,int noOfCasualties){
...
class Army extends Defence{
    ...
    Army(String nameOfHead,int noOfTroops,double budget,int noOfDept,int noOfVehicles,String locationOfHeadquarters,
         String countryName,int manpowerCount,int noOfBases,int noOfMissionsPerformed,int noOfCasualties,
         int noOfTanks,int noOfGuns,int noOfGrenades,int noOfBattalions){
        super(nameOfHead,noOfTroops,budget,noOfDept,noOfVehicles,locationOfHeadquarters,countryName,manpowerCount,noOfBases,
              noOfMissionsPerformed,noOfCasualties);
...
class Navy extends Defence{
    ...
    Navy(String nameOfHead,int noOfTroops,double budget,int noOfDept,int noOfVehicles,String locationOfHeadquarters,
         String countryName,int manpowerCount,int noOfBases,int noOfMissionsPerformed,int noOfCasualties,
         int noOfShips,int noOfSubmarines,int noOfTorpedoes){
        super(nameOfHead,noOfTroops,budget,noOfDept,noOfVehicles,locationOfHeadquarters,countryName,manpowerCount,noOfBases,
              noOfMissionsPerformed,noOfCasualties);
...
class AirForce extends Defence{
    ...
    AirForce(String nameOfHead,int noOfTroops,double budget,int noOfDept,int noOfVehicles,String locationOfHeadquarters,
             String countryName,int manpowerCount,int noOfBases,int noOfMissionsPerformed,int noOfCasualties,
             int noOfMissiles,int noOfAircrafts,int noOfSquadrons){
        super(nameOfHead,noOfTroops,budget,noOfDept,noOfVehicles,locationOfHeadquarters,countryName,manpowerCount,noOfBases,
              noOfMissionsPerformed,noOfCasualties);
...
public class DefenceInheritance{
    public static void main(String[] args){
        Army a=new Army("Gen. Rawat",50000,250000000,10,2000,"Delhi","India",60000,15,120,200,300,1000,5000,40);
        Navy n=new Navy("Adm. Kumar",30000,180000000,8,1000,"Mumbai","India",35000,10,60,120,40,10,100);
        AirForce af=new AirForce("Air Chief Chaudhari",40000,200000000,9,1500,"Bangalore","India",50000,12,80,150,500,120,20);
