...
public class FarmerInheritance{
    public static void main(String[] args){
        DairyFarmer df=new DairyFarmer(101,"Ramesh",5.5,"Pune",450000,8,20000,15,120,9876);
        PoultryFarmer pf=new PoultryFarmer(102,"Suresh",3.0,"Nashik",350000,6,15000,200,150,2,500,400,"FeatherNest");
        OrganicFarmer of=new OrganicFarmer(103,"Mahesh",4.2,"Kolhapur",400000,7,18000,555,"Vegetables","Natural Compost");
